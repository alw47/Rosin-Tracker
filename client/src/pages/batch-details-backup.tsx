          ...
          <CardContent className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="font-semibold">{convertWeight(batch.startAmount).toFixed(1)} {getWeightUnit()}</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
            ...
            {batch.temperature && (
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="font-semibold">{convertTemperature(batch.temperature).toFixed(0)}{getTemperatureUnit()}</p>
                </div>
              </div>
            )}
            {batch.pressure && (
